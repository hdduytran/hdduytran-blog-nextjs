      ...
      <div>
        <div className="items-start space-y-2 xl:grid xl:grid-cols-3 xl:gap-x-8 xl:space-y-0">
          <div className="flex flex-col items-center space-x-2 pt-8">
            ...
            <a
              href="https://drive.google.com/file/d/1wM2PR09Er_DMKv96W7blTyEKLiqWOIym/view?usp=sharing"
              target="_blank"
          ...
          <div className="prose max-w-none pb-8 pt-8 dark:prose-invert xl:col-span-2">
            ...
            <div className="techStack items-center gap-1 clear-both">
              ...
              {techStack.map((techstack) => (
                <div className="flex flex-wrap items-center gap-1 pt-1" key={techstack.scope}>
                  <div className="font-bold">{techstack.scope}: </div>
                  {techstack.stack.map((tool, index) => (
                    <TechStack tech={tool} key={`${tool}.${index}`} />
                  ))}
                </div>
              ))}
            </div>
